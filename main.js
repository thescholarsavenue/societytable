datax=[
  ...
  },
  {
    "Index": 8,
    "Symbol": "Wt",
    "Name": "Western Technology Music Group",
    "Year": 2008,
    "Size": "S",
    "Recognized": 1,
  ...
  },
  {
    ...
    "Size": "XL",
    "Recognized": 0,
    "Link": "https://www.facebook.com/groups/chessiitkgp/"
  },
  {
    "Index": 34,
    "Symbol": "Co",
...
$('.yes').each(function(i){
	...
	$(this).attr("title",datax[ind-1].Name);
	$(this).click(function(){
if(datax[ind-1].Link.indexOf('groups')==-1){window.open(datax[ind-1].Link+'about/?tab=page_info', '_blank');}
